//////////////////////// FRUIT COLLECTOR //////////////////////
///////  Written by Cecilia Aponthe and Huriye Kayis  ////////
...
var angx; // angle between 3 points with joint_3
var angle_grabber = 0; // grabber_base current angle at the moment
var angx_backup = 0;  // used for when grabber arms opened back
var orange_counter = 0;  // counts which orange is picked
var apple_counter = 0;  // counts which apple is picked
...
var orange_texture = new THREE.TextureLoader().load("orange.jpeg");
...
///////// FUNCTION TO SELECT CURRENTLY CHOSEN FRUIT ///////////////////
...
{	
	...
	/////// GET CLOSER TO FRUIT - ALIGN 2 AXIS  /////////////
	if (step_1_check)
